...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'silent@silentint.onmicrosoft.com',
  ...
  email: 'mailto:silentint@firefox.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/silentint',
    },
  ],
